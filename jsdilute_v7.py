...
# opentrons_simulate.exe jsdilute_v7.py
# opentrons_execute jsdilute_v7.py
# CD C:\OpenTronesProtocols\Jordan
# scp -i Ot2sshKey C:\OpenTronesProtocols\Jordan\jsdilute_v7.py root@169.254.168.129:
# scp -i Ot2sshKey C:\OpenTronesProtocols\Jordan\dilute.csv root@169.254.168.129:
# J@$0nRule$
...
metadata = {
    ...
    'description': 'This protocol dilutes a 96 well plate or 1.7ml tubes with water.',
    'author': 'Jordan Shore'
}
...
#transfer_mix_r transfers a volume and then mixes it immediately.
    def transfer_mix_r(vol, aspirateFrom, dispenseTo, changeTips, mixX):
        ...
        while vol > 300:
            big = True
            right_pipette.aspirate(300, aspirateFrom)
            right_pipette.dispense(300, dispenseTo)
            vol -= 300
            if changeTips == "once":
...
#Inputs for protocol.
    ...
    print("----------------------------------------------------------------------------------------!User Inputs!----------------------------------------------------------------------------------------")
#Protocol Intro
    print("This protocol will add water and mix to dilute in a 96 well plate, or 1.7ml tubes.")
...
#Asks user to specify how well mixed they want their dilutions.
        ...
        try:
            ...
            print("Error, Invalid Custom Mix Number!")
            mixX = 5
...
#Protocol Start
    ...
    startTime = time.time()
    right_pipette.well_bottom_clearance.aspirate = 90
    newBottom = 90
    ...
    for i in range(len(vollist)):
        ...
        if (vollist[i] == 0):
            ...
            newBottom = recalibrate_conical(newBottom,vollist[i],50)
            right_pipette.well_bottom_clearance.aspirate = newBottom
